...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    ...
    message(STATUS "#####PKGCONFIG_LIBS_DEBUG: ${PKGCONFIG_LIBS_DEBUG}")
    message(STATUS "#####PKGCONFIG_LIBS_RELEASE: ${PKGCONFIG_LIBS_RELEASE}")
    string(REGEX REPLACE "-l[^ ]*libstdc\\+\\+\\.a" "" PKGCONFIG_LIBS_DEBUG "${PKGCONFIG_LIBS_DEBUG}")
    string(REGEX REPLACE "-l[^ ]*libstdc\\+\\+\\.a" "" PKGCONFIG_LIBS_RELEASE "${PKGCONFIG_LIBS_RELEASE}")
    message(STATUS "#####PKGCONFIG_LIBS_DEBUG: ${PKGCONFIG_LIBS_DEBUG}")
    message(STATUS "#####PKGCONFIG_LIBS_RELEASE: ${PKGCONFIG_LIBS_RELEASE}")
